    ...
    @inbounds Threads.@threads for iy=1:Ny0
        @inbounds for iz=1:Nz0
            ...
            elseif spacetime=="Bardeen" #@Truong
                ...
                gxyn[iy,iz]=(-2.0*mBD*sin(pi*0.0)*sin(pi*ys[iy]))/(pi^2.0*(qBD^2.0 + tan((pi*0.0)/2.0)^2.0 + tan((pi*ys[iy])/2.0)^2.0 + tan((pi*zs[iz])/2.0)^2.0)^1.5);

                gxzn[iy,iz]=(-2.0*mBD*sin(pi*0.0)*sin(pi*zs[iz]))/(pi^2.0*(qBD^2.0 + tan((pi*0.0)/2.0)^2.0 + tan((pi*ys[iy])/2.0)^2.0 + tan((pi*zs[iz])/2.0)^2.0)^1.5);

                gyyn[iy,iz]=(4.0*cos((pi*ys[iy])/2.0)^4.0*((qBD^2.0 + tan((pi*0.0)/2.0)^2.0 + tan((pi*zs[iz])/2.0)^2.0)*sqrt(qBD^2.0 + tan((pi*0.0)/2.0)^2.0 + tan((pi*ys[iy])/2.0)^2.0 + tan((pi*zs[iz])/2.0)^2.0) + tan((pi*ys[iy])/2.0)^2.0*(-2.0*mBD + sqrt(qBD^2.0 + tan((pi*0.0)/2.0)^2.0 + tan((pi*ys[iy])/2.0)^2.0 + tan((pi*zs[iz])/2.0)^2.0))))/(pi^2.0*(qBD^2.0 + tan((pi*0.0)/2.0)^2.0 + tan((pi*ys[iy])/2.0)^2.0 + tan((pi*zs[iz])/2.0)^2.0)^1.5);

                gyzn[iy,iz]=(-2.0*mBD*sin(pi*ys[iy])*sin(pi*zs[iz]))/(pi^2.0*(qBD^2.0 + tan((pi*0.0)/2.0)^2.0 + tan((pi*ys[iy])/2.0)^2.0 + tan((pi*zs[iz])/2.0)^2.0)^1.5);

                gzzn[iy,iz]=(4.0*cos((pi*zs[iz])/2.0)^4.0*((qBD^2.0 + tan((pi*0.0)/2.0)^2.0 + tan((pi*ys[iy])/2.0)^2.0)*sqrt(qBD^2.0 + tan((pi*0.0)/2.0)^2.0 + tan((pi*ys[iy])/2.0)^2.0 + tan((pi*zs[iz])/2.0)^2.0) + tan((pi*zs[iz])/2.0)^2.0*(-2.0*mBD + sqrt(qBD^2.0 + tan((pi*0.0)/2.0)^2.0 + tan((pi*ys[iy])/2.0)^2.0 + tan((pi*zs[iz])/2.0)^2.0))))/(pi^2.0*(qBD^2.0 + tan((pi*0.0)/2.0)^2.0 + tan((pi*ys[iy])/2.0)^2.0 + tan((pi*zs[iz])/2.0)^2.0)^1.5);
